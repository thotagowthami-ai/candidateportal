...
let UsersController = class UsersController {
    ...
    async sendOtp(phone) {
        if (!phone)
            throw new common_1.UnauthorizedException('Phone number required');
        return this.usersService.sendOtp(phone);
    }
    async verifyOtp(body) {
        if (!body.phone || !body.otp) {
            throw new common_1.UnauthorizedException('Phone number and OTP required');
        }
        return this.usersService.verifyOtp(body.phone, body.otp);
    }
    async replaceResume(req, file) {
        if (!file) {
            throw new Error('No file uploaded');
        }
        return this.usersService.replaceResume(req.user.email, file);
    }
    async createUser(file, body) {
        return this.usersService.create(body, file);
    }
    async testCreate(payload) {
        if (process.env.DEV_BYPASS_OTP !== 'true') {
            throw new common_1.UnauthorizedException('Dev bypass not enabled');
        }
...
__decorate([
    (0, common_1.Get)('me/semantic'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "meSemantic", null);
__decorate([
    (0, common_1.Get)(':candidateId/resume'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "downloadResume", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "replaceResume", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "testCreate", null);
